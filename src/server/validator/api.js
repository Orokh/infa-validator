...
function postValidateFile(req, res) {
...
module.exports = app => {
	app.post('/api/file/upload', postUploadFile);

	app.delete('/api/file/delete/:id', deleteFile);

	app.post('/api/file/validate', postValidateFile);
};
